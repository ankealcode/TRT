...
process.stdout.write(
  String.fromCharCode(27) + "]0;" + `TikTok Report Tools | Reports: 0 | Speed: 0/m` + String.fromCharCode(7)
);
...
setInterval(() => {
  ...
  setInterval(() => {
    process.stdout.write(
      String.fromCharCode(27) + "]0;" + `TikTok Report Tools | Reports: ${reportCount} | Speed: ${reportsPerSecond*6}/m` + String.fromCharCode(7)
    );
    reportsPerSecond = 0
  }, 10000);
